<div>
    ...
    <form wire:submit.prevent="saveInvoice">
        ...
        <div>
            ...
            <input wire:model="customer_name" type="text" name="customer_name" class="focus:outline-none w-full border border-indigo-500 rounded-md p-1" value="{{ old('customer_name') }}" required>
        </div>
        <div>
            <label>Customer email</label>
            <input wire:model="customer_email" type="email" name="customer_email" class="focus:outline-none w-full border border-indigo-500 rounded-md p-1" value="{{ old('customer_email') }}">
        </div>
